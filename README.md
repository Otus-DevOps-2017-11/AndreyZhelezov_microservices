...
В описание сервиса **ui** добавлено описание драйвера логгинга _fluentd_. В файл **docker/fluentd/fluent.conf** добавлен фильтр неструктурированных логов который в логах сервиса _ui_ поле _log_ разделяет на отдельные поля при помощи парсинга регулярными выражениями.
